...
# todo 2) Написать алгоритм поиска количества кубиков методом деления отрезка пополам


def c(n):
    """Принимает количество кубиков. Возвращает количество комбинаций для введенног количества кубиков"""
    ...
    inner_massive_as_list = []  # внутренний массив комбинаций (a, b, c, n) в виде листа
    count = 0
